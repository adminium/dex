...
[![Go Report Card](https://goreportcard.com/badge/github.com/adminium/dex?style=flat-square)](https://goreportcard.com/report/github.com/adminium/dex)
[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod&style=flat-square)](https://gitpod.io/#https://github.com/adminium/dex)
...
| [SAML 2.0](https://dexidp.io/docs/connectors/saml/) | no | yes | no | stable | WARNING: Unmaintained and likely vulnerable to auth bypasses ([#1884](https://github.com/adminium/dex/discussions/1884)) |
...
- For feature requests and bugs, file an [issue](https://github.com/adminium/dex/issues).
- For general discussion about both using and developing Dex:
    ...
    - open a new [discussion](https://github.com/adminium/dex/discussions)
...
[issue-1065]: https://github.com/adminium/dex/issues/1065
[release-notes]: https://github.com/adminium/dex/releases
